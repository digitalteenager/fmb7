	...
	<div class="card" style="width: 70%;margin-top: 8px; padding: 30px; height: 90%;">
		<form method="POST" >
		  ...
		  <div class="form-group">
	 		...
	 		<textarea class="form-control" id="exampleFormControlTextarea1" name="text" rows="11" ><?=$row->text?></textarea>
	 		<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else*</small>
	 		<input type="hidden" class="form-control" name="image">
	 		<input type="hidden" class="form-control" name="pubdate">
		  </div>
		  <button type="submit" name="rePostBtn" class="btn btn-success">Submit</button>
		</form>
	</div>
</body>